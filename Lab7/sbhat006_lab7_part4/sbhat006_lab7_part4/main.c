/*
 * sbhat006_lab7_part1.c
 *
 * Created: 8/14/2017 10:13:51 AM
 * Author : Gogol
 */ 
...
enum SM_SOUND{SOUND_ON, SOUND_OFF, SOUND_WAIT} STATE_SOUND;
enum SM_FRQ{FRQ_WAIT, FRQ_UP_RE, FRQ_UP_FE, FRQ_DOWN_RE, FRQ_DOWN_FE} STATE_FRQ;
...
unsigned char minTime = 1;
unsigned char maxTIme = 100;
